	...
	try {
     ...
     const time2 = moment().tz('Asia/Jakarta').format('HH:mm:ss')
       ...
       console.error(err)
        ...
        const ftoko = {key: {fromMe: false,participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "16505434800@s.whatsapp.net" } : {})},message: {"productMessage": {"product": {"productImage":{"mimetype": "image/jpeg","jpegThumbnail": fs.readFileSync(`./media/ganteng.jpg`)},"title": `HALLO...${pushname}JANGAN LUPA DI ORDER`,"description": "V", "currencyCode": "IDR","priceAmount1000": "999999","retailerId": "v","productImageCount": 1},"businessOwnerJid": `0@s.whatsapp.net`}}}
...
case 'tiktok':
              ...
              imageMsg = (await dha.prepareMessageMedia(fs.readFileSync(`./media/sherlynn.jpg`), 'imageMessage', {thumbnail: fs.readFileSync(`./media/sherlynn.jpg`)})).imageMessage
              buttonsMessage = {footerText:'Jangan Lupa Subscribe Yt vintero\n Helpme tu 1k subscriber', imageMessage: imageMsg,
       ...
       case 'img2url':
         ...
         case 'asupan': // shansekai                
              ...
              .then(async (body) => {
               ...
               sendMediaURL(from, `http://sansekai.my.id/ptl_repost/${asupanx}`, '\`\`\`ASUPAN BRO GUA DAPAT DARI LORD ©vintero\`\`\`')
...
//------------------<18+ Menu>-----------------------   
       case 'randombokep':
              ...
              dha.sendMessage(from, '*PERMINTAAN:* '+bokep+'\n*DOSA TANGGUNG PRIBADI*\n*NI BRO FREE BUAT KAMU DOWNLOAD SENDIRI:* '+ kep, text, { quoted: ftoko, caption: `NI BOKEP SAYA DAPAT DARI *©vintero* DOSA TANGGUNG SENDIRI🗿`})
              break
                case 'xnxx':
...
dha.sendMessage(from, tapib1, document, { quoted: mek, filename:`vBot ~ 404 ${vipi}.mp3`, mimetype: 'audio/application' })
...
//------------------< serti menu >-------------------   
case 'sertitolol': 				
				if (args.length < 1) return reply(`Textnya Mana Cuy?\n*Contoh ${prefix}tololserti kevin ganteng`)
				ct = body.slice(12)
...
case 'tahta':
         ...
         break    
case 'pornhub':
         if (args.length == 0) return reply(`Contoh: ${prefix + command} vBot`)
         txt1 = args[0]
         txt2 = args[1]
...
//------------------< Menunya Bang:v >-------------------
      case 'dana':
             reply(`DANA : 085887879565\n\n SAYA CUMAN BISA BILANG TERIMAKASIH ATAS KEMURAHAN HATI TUAN TELAH MEMBERIKAN KAMI BANTUAN.SEMOGA TUHAN MEMBALAS APA YG TUAN BERIKAN KE PADA SAYA`)
             break
           case 'gopay':
             reply(`GOPAY : 085887879565\n\n SAYA CUMAN BISA BILANG TERIMAKASIH ATAS KEMURAHAN HATI TUAN TELAH MEMBERIKAN KAMI BANTUAN.SEMOGA TUHAN MEMBALAS APA YG TUAN BERIKAN KE PADA SAYA`)
             break  
         case 'pulsa':
             reply(`PULSA : 085887879565\n\n SAYA CUMAN BISA BILANG TERIMAKASIH ATAS KEMURAHAN HATI TUAN TELAH MEMBERIKAN KAMI BANTUAN.SEMOGA TUHAN MEMBALAS APA YG TUAN BERIKAN KE PADA SAYA`)
             break              
      case 'infoig':
             reply(`Jangan Lupa Follow Ig Owner Ya : https://www.instagram.com/vin.tero`)
             break
      case 'grupbot':
